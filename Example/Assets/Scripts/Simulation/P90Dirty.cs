...
public class P90Dirty : MonoBehaviour
{
    ...
    private void Update()
    {
        if (isClean == true)
        {
            ...
            {
                //ObjectyManager.Instance.ObjectyPools["ObjectyPool"].Spawn("CleanP90", transform.position, new Vector3(0, 180, 90)).transform.SetParent(transform.parent); // When we clear the weapon, it spawns a new weapon onto the platform.
    ...
    void PlaceWeapon()
    {
        ...
        { /*
            ...
            spawnedWeapon = ObjectyManager.Instance.ObjectyPools["ObjectyPool"].Spawn("CleanP90", gameManager.weaponPositions[gameManager.currentWeaponIndex].position);
            ...
            spawnedWeapon.GetComponent<P90Runner>().enabled = true;
